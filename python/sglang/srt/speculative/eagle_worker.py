...
class EAGLEWorker(TpModelWorker):
    ...
    def __init__(
        ...
        if not self.speculative_algorithm.is_nextn():
            ...
            self.hot_token_ids = self.hot_table.get_hot_token_ids()
    ...
    def forward_batch_speculative_generation(self, batch: ScheduleBatch):
        if batch.forward_mode.is_decode():
            ...
            print(accept_length_cpu)
            print(verified_id)
            self.hot_table.add_token(verified_id)
            self.hot_table.update_table(self.model_runner.model.lm_head.weight, self.target_worker_lm_haed.weight)
